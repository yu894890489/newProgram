...
import yu.entity.UserBean;
import yu.service.LoginService;

public class test {
	public static void main(String[] args) throws SQLException {
		String conf="applicationContext.xml";
		ApplicationContext ac=new ClassPathXmlApplicationContext(conf);
		LoginService service = (LoginService) ac.getBean("loginService");
		UserBean user = new UserBean();
		user.setName("admin");
		UserBean userBean = service.getUser(user);
